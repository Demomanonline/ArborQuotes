        ...
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <a
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 text-lg rounded-md inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-primary-foreground shadow"
            >
              Request a Quote
            </a>
          </div>
